...
import iuh.fit.se.interfaces.ChiTietHoaDon_SanPham_interface;
...
public class ChiTietHoaDon_SanPham_Services extends UnicastRemoteObject implements ChiTietHoaDon_SanPham_interface {
    private transient EntityManagerFactory emf;

    public ChiTietHoaDon_SanPham_Services() throws RemoteException {
        super();
