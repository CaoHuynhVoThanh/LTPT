...
import iuh.fit.se.App;
import iuh.fit.se.interfaces.KhachHang_interface;
import iuh.fit.se.interfaces.NhanVien_interface;
...
import iuh.fit.se.enums.LoaiHang;
import iuh.fit.se.security.Permission;
import iuh.fit.se.security.PermissionChecker;
...
public class QL_NhanVien_controller implements Initializable {
    ...
    void suaTTNV(MouseEvent event) {
        try{
            ...
            NhanVien nv = new NhanVien(maNV, tenNV, cccd, diaChi, email, sdt, LocalDate.parse(ngaySinh), chucVu);
