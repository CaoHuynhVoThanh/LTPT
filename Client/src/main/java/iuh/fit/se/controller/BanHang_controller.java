    ...
    private void createInvoice() {
        try {
            ...
            if (chiTietHoaDonDao == null) {
                ...
                try {
                    Registry registry = LocateRegistry.getRegistry("localhost", 9090);
                    chiTietHoaDonDao = (ChiTietHoaDon_SanPham_interface) registry.lookup("chiTietHoaDonDAO");
                    if (chiTietHoaDonDao == null) {
