...
public class QuenMatKhau_controller implements Initializable {
    ...
    private void handleResetPasswordAction(ActionEvent event) {
        ...
        try {
            ...
            iuh.fit.se.interfaces.NhanVien_interface nhanVienDao = (iuh.fit.se.interfaces.NhanVien_interface) registry.lookup("nhanVienDAO");

            // Tìm kiếm TaiKhoan_interface
            iuh.fit.se.interfaces.TaiKhoan_interface taiKhoanDao = (iuh.fit.se.interfaces.TaiKhoan_interface) registry.lookup("taiKhoanDAO");
